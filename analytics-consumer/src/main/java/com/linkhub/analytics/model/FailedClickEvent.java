...
public class FailedClickEvent {
    ...
    public FailedClickEvent(UUID eventId, String payload, String failureReason) {
        ...
        this.nextRetryAt = Instant.now().plusSeconds(60); // First retry after 1 minute
    }
    ...
    public void scheduleRetry() {
        ...
        this.nextRetryAt = Instant.now().plusSeconds(Math.min(backoffSeconds, 36000)); // Cap at 10h
    }
}
